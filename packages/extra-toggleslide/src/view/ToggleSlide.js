 ...
 */
Ext.define('Extra.ux.toggleslide.view.ToggleSlide', {
    extend: 'Ext.Component',
    alias: 'widget.toggleslide',
    
    requires: ['Extra.ux.toggleslide.view.Thumb', 'Ext.fx.Anim'],
    ...
    initComponent: function()
    {
        ...
        // Error: "Ext.util.Observable#addEvents" is deprecated.
        //me.addEvents(
                /**
    ...
    onRender: function()
    {
        ...
        me.thumb = new Extra.ux.toggleslide.view.Thumb({
            ownerCt: me,
            slider: me,
        ...
        {
            Extra.ux.toggleslide.view.ToggleSlide.superclass.disable.call(me);
        }
    },
    ...
    enable: function()
    {
        if(this.disabled)
        {
            Extra.ux.toggleslide.view.ToggleSlide.superclass.enable.call(this);
    ...
    disable: function()
    {
        if(!this.disabled)
        {
            Extra.ux.toggleslide.view.ToggleSlide.superclass.disable.call(this);
