// See https://www.sencha.com/forum/showthread.php?282740-Ext-4.2.1-use-a-glyph-in-a-actioncolumn-instead-of-a-css-icon
Ext.define('AknMetadata.grid.column.Action', {
  override: 'Ext.grid.column.Action',
  
  iconTpl: '<tpl for=".">' +
          '<tpl if="glyph">' +
          '<span class="{cls}" style="font-family:{glyphFamily};  font-size:15px; line-height: 15px;"<tpl if="tooltip"> data-qtip="{tooltip}"</tpl>>&#{glyph};</span>' +
          '<tpl else>' +
