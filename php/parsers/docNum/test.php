...
<head>
	...
	<title>Test page: parser for dates</title>
...
<body>
	...
	<h1>Test Unit per il parser di date</h1>
	
	<p class="content">Il servizio prende in input un testo contenente delle date in diversi formati
	e restituisce un JSON con tutte le date trovate, le date valide vengono trasformate nel formato aaaa-mm-dd.</p> 
...
<ul>
<li>POST http://www.site.com/dir/date/</li>
</ul>
