...
(function() {
	...
	tinymce.create("tinymce.plugins.TinyAutoSavePlugin", {
		...
		init: function (ed, url) {
			...
			tinymce.dom.Event.bind(window, "unload", s.saveFinalDelegate);
			/*
			 * tinymce 3.x
			...
			if (s.askBeforeUnload) {
			    tinymce.dom.Event.bind(window, "unload", tinymce.plugins.AutoSavePlugin._beforeUnloadHandler);
			    /*
                 * tinymce 3.x
	...
	function dispose() {
         ...
         */
		tinymce.dom.Event.unbind(window, "unload", s.saveFinalDelegate);
		...
		if (s.askBeforeUnload) {
             ...
             */
			tinymce.dom.Event.unbind(window, "unload", tinymce.plugins.AutoSavePlugin._beforeUnloadHandler);
		}
